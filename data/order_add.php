...
$output = [];
@$userid = $_REQUEST['userid'] or die ("[]");
@$phone = $_REQUEST['phone'] or die ("[]");
@$user_name = $_REQUEST['user_name'] or die ("[]");
@$addr = $_REQUEST['addr'] or die ("[]");
@$totalprice = $_REQUEST['totalprice'] or die ("[]");
@$cartDetail = $_REQUEST['cartDetail'] or die ("[]");
